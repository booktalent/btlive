...
export default function PaymentStep({
  ...
  // ── Easebuzz hosted checkout: user picks method on the Easebuzz page,
  // not ours. Render a single "Continue to Easebuzz" CTA instead of the
  // Card/UPI/Bank selector.
  if (isEasebuzz) {
    return (
      <div className="card card-pad" data-testid="step-5">
        ...
        <div style={{
          ...
          <p className="text-muted fs-13" style={{ margin: 0, lineHeight: 1.6 }}>
            ...
            straight back to BookTalent once payment is confirmed.
          </p>
          {easebuzzSandbox && (
